...
const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({ isOpen, onClose, onConfirm, url }) => {
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  ¿Estás seguro de que quieres eliminar la URL <span className="font-semibold text-gray-900">{url}</span>? Esta acción no se puede deshacer.
                </p>
              </div>
            </div>
          </div>
